...
class _UserScreenState extends State<UserScreen> {
  ...
  Future<void> _loadUser() async {
    try {
      ...
      // Giả sử bạn có model User đơn giản
              ...
              : SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    // _buildInfoRow(Icons.email_outlined, _user?.email ?? 'Chưa có email'),
                    // _buildInfoRow(Icons.location_on_outlined, _user?.address ?? 'Chưa có địa chỉ'),
                    // _buildInfoRow(Icons.cake_outlined, _user?.dateOfBirth != null
                    ...
                    const SizedBox(height: 25),
                    _buildListTile(
                      title: 'Gọi ĐƯỜNG DÂY NÓNG: 1800 1143',
                      icon: Icons.phone_outlined,
                      onTap: () {},
                    ),
                    _buildListTile(
                      title: 'Email: hotro@dalathasfarm.com',
                      icon: Icons.email_outlined,
                      onTap: () {},
                    ),
                    _buildListTile(
                    ...
                    Center(
                      child: OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: BorderSide(color: Color(0xFF4A7C59)),
                          padding: const EdgeInsets.symmetric(
                            horizontal: 40,
                            vertical: 12,
                          ),
